...
/* Decipher a multi-dimensional array of groups of letters based on a letter-to-number decipher object (i.e., the kind of object returned by leftIdentify). */

const rightIdentify = (decipher, rightArray) => {
    return rightArray.map(a => decipher[a.join('')]).join('');
}
